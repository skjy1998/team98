    ...
    <header className="sticky top-0 z-50 border-b border-stone-200/80 bg-stone-50/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 sm:py-4">
        ...
        >
          ...
          <Link
            href="/login"
            className="rounded-lg px-3 py-2 text-xs font-semibold text-stone-600 transition hover:bg-white hover:text-stone-900 sm:rounded-xl sm:px-4 sm:text-sm"
          >
            로그인
          </Link>
          ...
          <Link
            href="/signup"
            className="rounded-lg bg-emerald-600 px-3.5 py-2 text-xs font-bold text-white transition hover:bg-emerald-700 sm:rounded-xl sm:px-4 sm:text-sm"
          >
            시작하기
          </Link>
        </nav>
